...
const expenseOne = store.dispatch(addExpense({amount: 400, description: 'Rent', createdAt: 1000}))
const expenseTwo = store.dispatch(addExpense({amount: 400, description: 'Coffe', note: 'gold mine', createdAt: -1000}))
